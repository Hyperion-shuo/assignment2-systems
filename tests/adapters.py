...
def get_ddp_individual_parameters(module: torch.nn.Module) -> torch.nn.Module:
    ...
    from cs336_systems.collective_communication_utils import ddp_wrapper
    return ddp_wrapper(module)
...
def get_ddp_bucketed(module: torch.nn.Module, bucket_size_mb: float) -> torch.nn.Module:
    ...
    Returns:
        Instance of a DDP class.
    """
    from cs336_systems.collective_communication_utils import ddp_bucket_wrapper
    return ddp_bucket_wrapper(module, bucket_size_mb)
...
def get_sharded_optimizer(params, optimizer_cls: Type[torch.optim.Optimizer], **kwargs) -> torch.optim.Optimizer:
    ...
    """
    from cs336_systems.collective_communication_utils import zero_wrapper
    return zero_wrapper(params, optimizer_cls, **kwargs)
